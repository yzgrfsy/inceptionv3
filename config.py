...
data_dir = join_path(abspath, 'sorted')
...
fine_tuned_weights_path = join_path(trained_dir, 'fine-tuned-best-{}-weights.h5')
model_path = join_path(trained_dir, 'last-model-{}.h5')
...
def get_checkpoint_path():
    return checkpoint_path.format(model)
'''
